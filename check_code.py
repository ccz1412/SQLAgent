...
def main():
    ...
    files_to_check = [
        ...
        "src/agent/sql_generator_v2.py",
        "src/agent/react_agent_v2.py",
    ...
    import_tests = [
        ...
        ("src.agent.sql_generator_v2", "from src.agent.sql_generator_v2 import SQLGeneratorV2"),
        ("src.agent.react_agent_v2", "from src.agent.react_agent_v2 import ReactAgentV2"),
